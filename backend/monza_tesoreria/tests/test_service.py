...
(también:   ./venv/bin/python -m pytest monza_tesoreria/tests/test_service.py -q)
"""
import os
import sys
...
def test_monza_tesoreria_service():
    """Wrapper para pytest (espejo de tesoreria/tests/test_service.py de GA):
