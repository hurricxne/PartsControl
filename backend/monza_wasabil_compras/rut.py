...
COPIA FIEL de wasabil_compras/rut.py (Grupo AM) para MonzaParts — la duplicación entre
marcas es deliberada (regla de la casa): módulo PURO propio, sin importar nada de GA.
