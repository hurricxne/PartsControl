"""Libro de compras del SII — espejo local de los documentos RECIBIDOS de Wasabil.

Paquete NUEVO y aislado de Grupo AM / MachParts (empresa 'mineria'). No comparte código con
`wasabil_dte/` (el módulo de EMISIÓN, que ya emite documentos reales): este paquete es de
SOLO LECTURA por diseño — su cliente no tiene, ni tendrá, ninguna función capaz de crear,
emitir, anular ni modificar un documento tributario.
