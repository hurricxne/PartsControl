"""Helpers y serializadores del módulo Recepción Nacional (autocontenido).
...
ItemCotizacion), aquí solo quedan las utilidades puras."""
...
def _serialize_item(ri) -> dict:
    return {
        ...
        "oc_proveedor_item_id": ri.oc_proveedor_item_id,
